...
import com.ts.music.databinding.ItemCurrentlyRadioListBinding;
...
public class RadioCurrentlyListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemCurrentlyRadioListBinding binding = ItemCurrentlyRadioListBinding
    ...
    public static class RadioViewHolder extends RecyclerView.ViewHolder {
        private ItemCurrentlyRadioListBinding mBinding;

        public RadioViewHolder(@NonNull ItemCurrentlyRadioListBinding binding) {
